...
activities = {
    ...
    "Soccer Team": {
        "description": "Team-based soccer practice and interschool matches",
    ...
    "Drama Club": {
        "description": "Build acting skills and produce school plays",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["zoe@mergington.edu", "jordan@mergington.edu"]
    },
    "Math Club": {
    ...
    "Science Olympiad": {
        "description": "Study science concepts and compete in STEM events",
